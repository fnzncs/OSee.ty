...
if (isset($_POST['id'])) {
    ...
    $query = "UPDATE `schedule_list` SET `status` = 'accepted' WHERE id = ?";
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        // Move accepted request to processschedule_list
        ...
        session_start();
        $_SESSION['message'] = "Booking request accepted"; // Set success message in session
