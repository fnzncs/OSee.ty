...
<head>
    ...
    <title>Admin - AmpiTheater Report</title>
    ...
    <script type="text/javascript">
        ...
        function drawCharts() {
            fetch('./database/getchar_ampitheater.php?venue=ampi-theater')
                .then(response => response.json())
                .then(data => {
                    // Column Chart for Ampi-Theater bookings (Monthly)
                    ...
                    var monthlyOptions = {
                        title: 'Ampi-Theater Bookings (Monthly)',
                        hAxis: {title: 'Date'},
                        vAxis: {title: 'Number of Bookings'}
                    };

                    var monthlyChart = new google.visualization.ColumnChart(document.getElementById('ampi-theater_monthly_chart'));
                    monthlyChart.draw(monthlyData, monthlyOptions);

                    // Column Chart for Ampi-Theater bookings (Weekly)
                    ...
                    var weeklyOptions = {
                        title: 'Ampi-Theater Bookings (Weekly)',
                        hAxis: {title: 'Date'},
                        vAxis: {title: 'Number of Bookings'}
                    };

                    var weeklyChart = new google.visualization.ColumnChart(document.getElementById('ampi-theater_weekly_chart'));
                    ...
                    var statusOptions = {
                        title: 'Ampi-Theater Booking Statuses (Monthly)',
                        pieHole: 0.4,
                    };

                    var statusChart = new google.visualization.PieChart(document.getElementById('ampi-theater_status_chart'));
    ...
    <div class="wrapper">
        ...
        <div class="main_body">
            ...
            <div class="report daily_report">
                ...
                <div id="ampi-theater_status_chart" style="width: 100%; height: 500px;"></div>

                <form action="/Osee.ty.admin/export/export_ampi_theater.php" method="POST" style="margin-top: 20px;">
                    <input type="hidden" name="venue" value="ampi_theater"> 
            ...
            <div class="report weekly_report">
                <h3>Weekly Report</h3>
                <div id="ampi-theater_weekly_chart" style="width: 100%; height: 500px;"></div>
            </div>
