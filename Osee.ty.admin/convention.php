...
<head>
    ...
    <title>Admin - Convention Report</title>
    ...
    <script type="text/javascript">
        ...
        function drawCharts() {
            fetch('./database/getchar_convention.php?venue=convention')
                .then(response => response.json())
                .then(data => {
                    // Column Chart for Convention bookings (Monthly)
                    ...
                    var monthlyOptions = {
                        title: 'Convention Bookings (Monthly)',
                        hAxis: {title: 'Date'},
                        vAxis: {title: 'Number of Bookings'}
                    };

                    var monthlyChart = new google.visualization.ColumnChart(document.getElementById('convention_monthly_chart'));
                    monthlyChart.draw(monthlyData, monthlyOptions);

                    // Column Chart for Convention Bookings (Weekly)
                    ...
                    var weeklyOptions = {
                        title: 'Convention Bookings (Weekly)',
                        hAxis: {title: 'Date'},
                        vAxis: {title: 'Number of Bookings'}
                    };
                    ...
                    var statusChart = new google.visualization.PieChart(document.getElementById('convention_status_chart'));
    ...
    <div class="wrapper">
        ...
        <div class="main_body">
            ...
            <div class="report weekly_report">
                <h3>Weekly Report</h3>
                <div id="convention_weekly_chart" style="width: 100%; height: 500px;"></div>
            </div>
